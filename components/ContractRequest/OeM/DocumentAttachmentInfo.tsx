...
import { IContractRequest, IProject, IProposeOeMInfo } from "@/utils/models";
import {
  FullMetadata,
  UploadResult,
  getDownloadURL,
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <span className="block text-center font-normal text-gray-400">
                      {typeof files.propostaComercial != "string"
                        ...
                        : formatLongString(files.propostaComercial, 35)}
                    </span>
                  </div>
                ) : (
                  <div className="flex flex-col items-center">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <span className="block text-center font-normal text-gray-400">
                      {typeof files.documentoComFoto != "string"
                        ...
                        : formatLongString(files.documentoComFoto, 35)}
                    </span>
                  </div>
                ) : (
                  <div className="flex flex-col items-center">
                      ...
                      <div className="flex flex-col items-center">
                        ...
                        <span className="block text-center font-normal text-gray-400">
                          {typeof files.contratoSocial != "string"
                            ...
                            : formatLongString(files.contratoSocial, 35)}
                        </span>
                      </div>
                    ) : (
                      <div className="flex flex-col items-center">
                      ...
                      <div className="flex flex-col items-center">
                        ...
                        <span className="block text-center font-normal text-gray-400">
                          {typeof files.cartaoCnpj != "string"
                            ...
                            : formatLongString(files.cartaoCnpj, 35)}
                        </span>
                      </div>
                    ) : (
                      <div className="flex flex-col items-center">
