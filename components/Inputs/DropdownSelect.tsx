  ...
  return (
    <div
      ...
      className={`relative flex h-[40px] items-center ${
        width ? `w-full lg:w-[${width}]` : "w-full lg:w-[400px]"
      }`}
    >
      <div className="flex h-full w-full items-center justify-between rounded-md border border-gray-200 bg-[#fff] p-2 shadow-sm">
        {selectMenuIsOpen ? (
          <input
            type="text"
            autoFocus
