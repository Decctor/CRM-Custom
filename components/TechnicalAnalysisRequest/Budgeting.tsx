        ...
        <div className="mt-4 flex w-full flex-col bg-[#fff] px-2">
          ...
          <div className="mt-4 flex items-center justify-center">
            <SelectInput
              ...
              width={"100%"}
              value={requestInfo.tipoOrcamentacao}
              selectedItemLabel="NÃO DEFINIDO"
              options={[
              ...
              handleChange={(value) =>
                setRequestInfo((prev) => ({ ...prev, tipoOrcamentacao: value }))
              }
              onReset={() =>
                setRequestInfo((prev) => ({
                  ...prev,
          ...
          <div className="mt-2 flex w-full flex-col items-center self-center">
            ...
            <textarea
              placeholder={
                "Adicione aqui observações para execução do orçamento..."
              }
              value={requestInfo.descricaoOrcamentacao}
              onChange={(e) =>
                setRequestInfo({
                  ...requestInfo,
