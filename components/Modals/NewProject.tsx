...
type NewProjectProps = {
  responsibles: IResponsible[] | null;
  closeModal: () => void;
};
...
function NewProject({ closeModal, responsibles }: NewProjectProps) {
              ...
              <div className="grid grid-cols-1 px-2">
                <div className="flex w-full flex-col gap-1">
                  ...
                  <DropdownSelect
                    ...
                    options={
                      responsibles
                        ? responsibles.map((representative) => {
                            return {
                  ...
                  <DropdownSelect
                    ...
                    onChange={(selected) =>
                      setNewProject((prev) => ({
                        ...prev,
                        funis: [
                          { id: prev.funis[0].id, etapaId: selected.value },
                        ],
                      }))
                    }
                    onReset={() =>
